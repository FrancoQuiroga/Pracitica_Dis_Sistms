"""
Script para buscar el paquete python_autonomous_fleet desde el directorio raiz del proyecto.
...
def main():
    ...
    if len(sys.argv) > 1:
        ...
        if comando == "integrar":
            ...
            print("  (sin argumentos)     Busca el paquete python_autonomous_fleet")
            ...
            print("  python buscar_paquete.py integrar python_autonomous_fleet")
            return 0
    ...
    print(f"[INFO] Buscando paquete: python_autonomous_fleet")
    print("")

    # Buscar el paquete
    paquetes = buscar_paquete(directorio_raiz, "python_autonomous_fleet")
    ...
    if paquetes:
        ...
        print("[!] No se encontro el paquete python_autonomous_fleet")
        return 1
